...
(function (w) {
  const DICT = {
    en: {
      ...
      create_sub: 'Upload a video you own or paste a direct video-file link. No proxy or downloader service.',
      tab_upload: 'Upload file', tab_url: 'Direct file link',
      drop: 'Drop a video here, or click to choose', drop_hint: 'MP4, MOV, WebM or MKV · up to 1GB',
      url_ph: 'https://cdn.example.com/video.mp4',
      ...
      err_choose_file: 'Choose a video file first', err_paste_url: 'Paste a direct video-file URL first',
    ...
    hi: {
      ...
      create_sub: 'अपना वीडियो अपलोड करें या वीडियो फ़ाइल का सीधा लिंक पेस्ट करें। किसी प्रॉक्सी की ज़रूरत नहीं।',
      tab_upload: 'फ़ाइल अपलोड', tab_url: 'सीधा फ़ाइल लिंक',
      drop: 'वीडियो यहाँ छोड़ें, या चुनने के लिए क्लिक करें', drop_hint: 'MP4, MOV, WebM या MKV · 1GB तक',
      url_ph: 'https://cdn.example.com/video.mp4',
      ...
      err_choose_file: 'पहले वीडियो फ़ाइल चुनें', err_paste_url: 'पहले वीडियो फ़ाइल का सीधा URL पेस्ट करें',
    ...
    es: {
      ...
      create_sub: 'Sube un video propio o pega un enlace directo al archivo. Sin proxy ni descargador.',
      tab_upload: 'Subir archivo', tab_url: 'Enlace directo',
      drop: 'Suelta un video aquí o haz clic para elegir', drop_hint: 'MP4, MOV, WebM o MKV · hasta 1GB',
      url_ph: 'https://cdn.example.com/video.mp4',
      ...
      err_choose_file: 'Elige un archivo de video', err_paste_url: 'Pega la URL directa de un archivo de video',
    ...
    pt: {
      ...
      create_sub: 'Envie um vídeo seu ou cole um link direto para o arquivo. Sem proxy ou baixador.',
      tab_upload: 'Enviar arquivo', tab_url: 'Link direto',
      drop: 'Solte um vídeo aqui ou clique para escolher', drop_hint: 'MP4, MOV, WebM ou MKV · até 1GB',
      url_ph: 'https://cdn.example.com/video.mp4',
      ...
      err_choose_file: 'Escolha um arquivo de vídeo', err_paste_url: 'Cole a URL direta de um arquivo de vídeo',
    ...
    fr: {
      ...
      create_sub: 'Importez votre vidéo ou collez un lien direct vers le fichier. Sans proxy ni téléchargeur.',
      tab_upload: 'Importer', tab_url: 'Lien direct',
      drop: 'Déposez une vidéo ici, ou cliquez', drop_hint: 'MP4, MOV, WebM ou MKV · jusqu\u2019à 1 Go',
      url_ph: 'https://cdn.example.com/video.mp4',
      ...
      err_choose_file: 'Choisissez une vidéo', err_paste_url: 'Collez l\u2019URL directe d\u2019un fichier vidéo',
    ...
    ar: {
      ...
      create_sub: 'ارفع فيديو تملكه أو الصق رابطاً مباشراً لملف الفيديو، من دون وكيل أو خدمة تنزيل.',
      tab_upload: 'رفع ملف', tab_url: 'رابط ملف مباشر',
      drop: 'أفلت فيديو هنا أو انقر للاختيار', drop_hint: 'MP4 أو MOV أو WebM أو MKV · حتى 1 غيغابايت',
      url_ph: 'https://cdn.example.com/video.mp4',
      ...
      err_choose_file: 'اختر ملف فيديو أولاً', err_paste_url: 'الصق رابطاً مباشراً لملف فيديو أولاً',
